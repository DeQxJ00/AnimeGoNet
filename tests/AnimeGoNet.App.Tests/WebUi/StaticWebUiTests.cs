...
public sealed class StaticWebUiTests
{
    ...
    [InlineData("/", "text/html", "/styles.css?v=20260829-visible-disabled-postprocess")]
    ...
    [InlineData("/styles.css", "text/css", ".movie-library-delete-menu")]
    [InlineData("/styles.css", "text/css", ".mixed-media-tmdb-link")]
    [InlineData("/styles.css", "text/css", ".anitomy-title-candidate")]
    ...
    [InlineData("/app.js", "text/javascript", "/manual-assignment")]
    [InlineData("/app.js", "text/javascript", "手动指定")]
    [InlineData("/", "text/html", "manual-metadata-assignment-dialog")]
    ...
    [InlineData("/app.js", "text/javascript", "inner_plugin_u2")]
    ...
    [InlineData("/", "text/html", "/app.js?v=20260829-visible-disabled-postprocess")]
    ...
    [InlineData("/styles.css", "text/css", ".movie-file-role-select[data-role=\"movie\"]")]
    [InlineData("/styles.css", "text/css", ".movie-file-role-select[data-role=\"extras\"]")]
    [InlineData("/app.js", "text/javascript", "符号链接（大小为目标文件）")]
    [InlineData("/app.js", "text/javascript", "U2 AniDB 映射 + TMDB 验证")]
    ...
    [InlineData("/", "text/html", "library-detail-manual-assignment")]
    ...
    [InlineData("/app.js", "text/javascript", "dataset.libraryManualTask")]
