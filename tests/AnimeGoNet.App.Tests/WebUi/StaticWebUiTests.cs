...
public sealed class StaticWebUiTests
{
    ...
    [InlineData("/", "text/html", "/styles.css?v=20260814-web-api-helper")]
    ...
    [InlineData("/", "text/html", "filter/mikan_tool.py")]
    [InlineData("/app.js", "text/javascript", "/api/config?key=all&backup=true")]
    [InlineData("/app.js", "text/javascript", "油猴插件填写这里的同一明文值")]
    ...
    [InlineData("/", "text/html", "/app.js?v=20260814-web-api-helper")]
