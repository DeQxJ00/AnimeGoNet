...
public sealed class StaticWebUiTests
{
    ...
    [InlineData("/", "text/html", "/styles.css?v=20260825-mikan-plugin-audit-title")]
    ...
    [InlineData("/styles.css", "text/css", ".download-tmdb-metadata")]
    [InlineData("/styles.css", "text/css", ".matching-log-flow")]
    ...
    [InlineData("/app.js", "text/javascript", "/api/v1/library/movies?page=1&page_size=1")]
    [InlineData("/app.js", "text/javascript", "selectWorkspace(\"library\", \"movies\")")]
    [InlineData("/", "text/html", "overview-library-movies-count")]
    [InlineData("/", "text/html", "data-subview=\"movies\"")]
    ...
    [InlineData("/app.js", "text/javascript", "/api/v1/ingest/manual")]
    ...
    [InlineData("/", "text/html", "/app.js?v=20260825-mikan-plugin-audit-title")]
    ...
    [InlineData("/app.js", "text/javascript", "/ai-series-change-review/reject")]
    [InlineData("/app.js", "text/javascript", "同意 AI 的 TMDB ID 变更")]
    [InlineData("/app.js", "text/javascript", "AI TMDB 变更待审核")]
    [InlineData("/app.js", "text/javascript", "多语言标题命中不同 TMDB Series")]
    ...
    [InlineData("/", "text/html", "overview-download-dead")]
    [InlineData("/app.js", "text/javascript", "7 天零进度，已自动暂停")]
    [InlineData("/styles.css", "text/css", ".download-card.dead")]
