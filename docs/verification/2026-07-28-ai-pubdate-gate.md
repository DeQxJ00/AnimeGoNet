...
- Core：普通正整数过滤、只选已播条目、稳定 tie-break、小数/特别篇排除。原 31 日 Torrent 发布窗口已于 2026-08-09 按业务确认删除。2026-08-13 最终细化为：季度和普通 EP 的主日期匹配均允许 `±1` 日；EP 主匹配失败后，仅实际单文件可用文件名 EP 做最多 7 日的最近日期一致性补判。
