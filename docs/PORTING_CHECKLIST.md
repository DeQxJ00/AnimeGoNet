...
| RSS 黑白名单→有序规则组 | `MikanRssRuleEngine` | 扩展 | 进行中 | schema v13 规则、API/WebUI、有界 RSS、来源 EP、纯计划及 schema v14 决策审计/幂等/winner 租约已验证；legacy filter 与 winner ingest 完成事务待实现 |
