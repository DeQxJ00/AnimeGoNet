...
| RSS 黑白名单→有序规则组 | `MikanRssRuleEngine` | 扩展 | 进行中 | schema v13、GET/PUT/preview、TypeScript WebUI、有界 RSS XML、来源 EP 和纯批次 winner/loser plan 已验证；legacy filter、决策落库与 winner ingest 副作用门禁待实现 |
