...
function matchingLogStage(item, label, stage, strategy, runId, attemptId) {
    const row = document.createElement("li");
...
async function loadMatchingLogs() {
    ...
    try {
        ...
        const cards = body.items.map(item => {
            ...
            flow.append(matchingLogStage(item, "Series", "series", item.series_strategy, item.series_run_id, item.series_attempt_id), matchingLogStage(item, "Season", "season", item.season_strategy, item.season_run_id, item.season_attempt_id), matchingLogStage(item, "Episode", "episode", item.episode_strategy, item.episode_run_id, item.episode_attempt_id));
